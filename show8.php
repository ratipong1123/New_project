...
<div class="navbar-collapse">
  ...
  <div class="container">
    <div class="panel panel-info">
          <div class="panel-heading">ข้อมูลวัสดุครุภัณฑ์&nbsp;
          </div>
...
<?php
 ...
 <?php
    ...
    {
      $sql = "SELECT * FROM data_material  WHERE Category ='เครื่องคอมและจอภาพ LCD 19 นิ้ว' order by ID_material";
    }
  ...
  ?>
    <tbody>
      <tr>
        ...
        <td> 
        <a href="#edit<?php echo $ID_material;?>" data-toggle="modal"><button  type='button' Title="ยืมพัสดุ" class='btn btn btn-success'>ยืมวัสดุ<span class="glyphicon-plus"></span></button></td>
      </tr>
</div>
