...
<?php
 ...
 <?php
    ...
    {
      $sql = "SELECT * FROM data_material,form_petiton Where data_material.ID_material  = form_petiton.ID_material ";
    }
...
<div class="col-sm-6"> 
        <form  method="POST">
         ...
         <label for="petition_id">รหัสการยืม:</label>
          ...
          <label for="ID_material">เลขพัศดุ:</label>
...
<div class="col-lg-6">  
        <form action="add3.php" method="POST">
          <div class="form-group">
          <label for="ID_material">เลขพัศดุ:</label>
          <input type="text" class="form-control" name="ID_material" id="ID_material" placeholder="เลขพัศดุ">


          <label for="Name_material">ชื่อพัศดุ:</label>
          <input type="text" class="form-control" name="Name_material" id="Name_material" placeholder="ชื่อพัศดุ">
